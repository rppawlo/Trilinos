#ifndef __Panzer_ResponseEvaluatorFactory_Point_impl_hpp__
#define __Panzer_ResponseEvaluatorFactory_Point_impl_hpp__
...
#include "Panzer_ResponseScatterEvaluator_Point.hpp"
#include "Panzer_Response_Point.hpp"

namespace panzer {

template <typename EvalT,typename LO,typename GO>
Teuchos::RCP<ResponseBase> ResponseEvaluatorFactory_Point<EvalT,LO,GO>::
buildResponseObject(const std::string & responseName) const
{
  Teuchos::RCP<ResponseBase> response = Teuchos::rcp(new Response_Point<EvalT>(responseName,comm_,linearObjFactory_));
...
template <typename EvalT,typename LO,typename GO>
void ResponseEvaluatorFactory_Point<EvalT,LO,GO>::
                           ...
                           const Teuchos::ParameterList & user_data) const
{
   ...
   {
     Teuchos::RCP<PointScatterBase> scatterObj =
         (globalIndexer_!=Teuchos::null) ?  Teuchos::rcp(new PointScatter<LO,GO>(globalIndexer_)) : Teuchos::null;
     ...
     Teuchos::RCP<PHX::Evaluator<panzer::Traits> > eval
       = Teuchos::rcp(new ResponseScatterEvaluator_Point<EvalT,panzer::Traits,LO,GO>(responseName,
                                                                                     comm_,
                                                                                     field,
                                                                                     fieldComponent_,
                                                                                     point_,
...
template <typename EvalT,typename LO,typename GO>
bool ResponseEvaluatorFactory_Point<EvalT,LO,GO>::
typeSupported() const
{
