#ifndef __Panzer_ResponseEvaluatorFactory_Point_hpp__
#define __Panzer_ResponseEvaluatorFactory_Point_hpp__
...
class ResponseEvaluatorFactory_Point : public ResponseEvaluatorFactory<EvalT> {
public:

  ResponseEvaluatorFactory_Point(
    MPI_Comm comm,
  ...
  virtual ~ResponseEvaluatorFactory_Point() {}
...
struct PointResponse_Builder : public ResponseMESupportBuilderBase {
  MPI_Comm comm;
  ...
  PointResponse_Builder() : applyDirichletToDerivative(false) {}

  virtual ~PointResponse_Builder() {}
  ...
  { return Teuchos::rcp(new ResponseEvaluatorFactory_Point<T,LO,GO>(comm,point,fieldComponent,cubatureDegree,fieldName,
...
#include "Panzer_ResponseEvaluatorFactory_Point_impl.hpp"
