#ifndef __Panzer_Response_Point_hpp__
#define __Panzer_Response_Point_hpp__
...
class Response_Point : public ResponseMESupport_Default<EvalT>,
                       public GlobalEvaluationData_BCAdjustment {
public:
  typedef typename EvalT::ScalarT ScalarT;

  ScalarT value;
  bool have_point;  // Point for point is on our processor
...
private:
  ...
  // hide these methods
  Response_Point();
  Response_Point(const Response_Point &);
