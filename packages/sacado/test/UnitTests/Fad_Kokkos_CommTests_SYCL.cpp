...
FAD_KOKKOS_COMM_TESTS_SYCL(CacheFad_SLFadType, CacheFad_SLFad)
FAD_KOKKOS_COMM_TESTS_SYCL(CacheFad_SFadType, CacheFad_SFad)

FAD_KOKKOS_COMM_TESTS_SYCL(ELRFad_SLFadType, ELRFad_SLFad)
FAD_KOKKOS_COMM_TESTS_SYCL(ELRFad_SFadType, ELRFad_SFad)

FAD_KOKKOS_COMM_TESTS_SYCL(ELRCacheFad_SLFadType, ELRCacheFad_SLFad)
FAD_KOKKOS_COMM_TESTS_SYCL(ELRCacheFad_SFadType, ELRCacheFad_SFad)

#if defined(KOKKOS_HAS_SHARED_SPACE)
FAD_KOKKOS_COMM_TESTS_SYCL(Fad_DFadType, Fad_DFad)
FAD_KOKKOS_COMM_TESTS_SYCL(CacheFad_DFadType, CacheFad_DFad)
FAD_KOKKOS_COMM_TESTS_SYCL(ELRFad_DFadType, ELRFad_DFad)
FAD_KOKKOS_COMM_TESTS_SYCL(ELRCacheFad_DFadType, ELRCacheFad_DFad)
#endif
